// const xmlToJSonConvertor = "https://api.rss2json.com/v1/api.json?rss_url=";

// // FOr iterating through all the magazine items and converting them into json format ->

// console.log(jsonData);
// magazines.map((items, index) => {
//     console.log(xmlToJSonConvertor+items);
// })
